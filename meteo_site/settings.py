"""
Django settings for meteo_site project.
...
WSGI_APPLICATION = 'meteo_site.wsgi.application'
...
# Pour permettre à Django de servir les fichiers statiques en production (Render)
import os
if not DEBUG:
...
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD')  # mot de passe d’application (voir étape 2)
